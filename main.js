...
toggler_icon.onclick = () => {
    toggler_icon.classList.toggle('fa-xmark');
...
window.onscroll = () => {
    ...
    toggler_icon.classList.remove('fa-xmark');
...
ScrollReveal().reveal('.home-image, .services-container, .portfolio-box, .contact form, .footer', {origin: 'bottom'});
ScrollReveal().reveal('.home-content h1, .about-img', {origin: 'left'});
ScrollReveal().reveal('.home-content p, .about-content', {origin: 'right'});

// typed js
const typed = new Typed('#my-role', {
